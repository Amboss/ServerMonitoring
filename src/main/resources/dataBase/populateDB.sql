...
INSERT IGNORE INTO `system_settings`(`id`, `settings_name`, `scan_interval`, `timeout`,`reload_time`,
`smtp_host`, `smtp_port`, `username`, `password`)
VALUES (01, 'default', 5000, 5000, 5000, 'smtp.gmail.com', 587, 'huskyserge@gmail.com', 'byxweoftrbofioov');