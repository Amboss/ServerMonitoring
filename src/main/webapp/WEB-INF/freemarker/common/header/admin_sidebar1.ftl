        ...
        <div class="row">
            <div class="span3 bs-docs-sidebar">
                <ul class="nav nav-list bs-docs-sidenav affix-top">
                    ...
                    <li><a href="../employee_management/employee_manager.html"><i class="icon-chevron-right"></i>Employee management</a></li>
                    ...
                    <li><a href="../server_management/serv_registr.html"><i class="icon-chevron-right"></i>Server registration</a></li>
                    <li><a href="../server_management/serv_update.html"><i class="icon-chevron-right"></i>Server update</a></li>
                    <li><a href="../server_management/serv_removal.html"><i class="icon-chevron-right"></i>Server removal</a></li>
                    <li><a href="../server_management/serv_manager.html"><i class="icon-chevron-right"></i>Server manager</a></li>
                </ul>
            </div>
        </div>
    </div>
